...
public class Ejemplo1 {
    ...
    /**
     * corresponde al html de login de RTM Se va a ubicar el input de usuario
     * mediante el atributo xml name
     * <input _ngcontent-gum-c1="" class="form-control obligatorio ng-untouched ng-pristine ng-valid" name="usuario">
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        String xPathExpression = "//input[@name='usuario']";
        ...
        //como se puede evidenciar a pesar de que hay dos datos se extrae solo el que estamos buscando
        for (int i = 0; i < nodos.getLength(); i++) {
            System.out.println(nodos.item(i));
